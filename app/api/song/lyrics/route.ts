...
const requestSchema = z.object({ title: z.string().optional(), artist: z.string().optional(), manualLyrics: z.string().max(12000).optional(), fixtureId: z.string().optional(), useFixture: z.boolean().default(false) });
